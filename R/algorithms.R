...
emc_algorithm_tags <- function(algorithms) {
    ...
    algorithms %>% dplyr::select(algorithm) %>% inner_join(tags, by = "algorithm")
}

#' Lists libraries required by emc algorithms
#'
...
#'
#' @param algorithms Input algorithms as returned by /code{emc_algorithms}
...
#'
#' Given a number of algorithms given as a tibble, returns a script that will install the
